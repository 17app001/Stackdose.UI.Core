...
using Stackdose.App.VerifySinglePageVmTmp.Pages;
using Stackdose.App.VerifySinglePageVmTmp.Services;
using Stackdose.App.VerifySinglePageVmTmp.ViewModels;

namespace Stackdose.App.VerifySinglePageVmTmp;
...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _viewModel = new MainWindowViewModel(
            runtimeService: new SinglePageRuntimeService("Stackdose.App.VerifySinglePageVmTmp"),
            closeAction: Close,
