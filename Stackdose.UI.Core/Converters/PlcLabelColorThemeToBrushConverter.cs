        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is PlcLabelColorTheme theme)
            {
                ...
                return theme switch
                {
                    ...
                    PlcLabelColorTheme.Primary    => Application.Current.TryFindResource("PlcFill.Primary") as Brush ?? new SolidColorBrush(Color.FromRgb(0x21, 0x96, 0xF3)),
                    PlcLabelColorTheme.Success    => Application.Current.TryFindResource("PlcFill.Success") as Brush ?? new SolidColorBrush(Color.FromRgb(0x4C, 0xAF, 0x50)),
                    PlcLabelColorTheme.Warning    => Application.Current.TryFindResource("PlcFill.Warning") as Brush ?? new SolidColorBrush(Color.FromRgb(0xFF, 0x98, 0x00)),
                    PlcLabelColorTheme.Error      => Application.Current.TryFindResource("PlcFill.Error")   as Brush ?? new SolidColorBrush(Color.FromRgb(0xF4, 0x43, 0x36)),
                    PlcLabelColorTheme.Info       => Application.Current.TryFindResource("PlcFill.Info")    as Brush ?? new SolidColorBrush(Color.FromRgb(0x00, 0xBC, 0xD4)),

                    PlcLabelColorTheme.NeonBlue   => Application.Current.TryFindResource("Cyber.NeonBlue")  as Brush ?? new SolidColorBrush(Color.FromRgb(0x00, 0xE5, 0xFF)),
                    PlcLabelColorTheme.NeonRed    => Application.Current.TryFindResource("Cyber.NeonRed")   as Brush ?? new SolidColorBrush(Color.FromRgb(0xFF, 0x17, 0x44)),
                    PlcLabelColorTheme.NeonGreen  => Application.Current.TryFindResource("Cyber.NeonGreen") as Brush ?? new SolidColorBrush(Color.FromRgb(0x00, 0xE6, 0x76)),
                    ...
                    PlcLabelColorTheme.Black      => Application.Current.TryFindResource("PlcFill.Black")   as Brush ?? new SolidColorBrush(Color.FromRgb(0x1A, 0x1A, 0x2E)),
