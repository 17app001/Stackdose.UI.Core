...
/// <summary>
/// Overview 卡片即時更新 — 讀取 PLC 資料更新到卡片 UI。
/// </summary>
public sealed class OverviewRuntimeMapper
{
    ...
    public void BuildRuntimeMaps(IReadOnlyDictionary<string, MachineConfig> machines, IRuntimeMappingAdapter adapter)
    {
