...
using System.Windows.Controls.Primitives; // ?? �[�J�o�Ӥޥ�
...
namespace Stackdose.UI.Core.Controls
{
    ...
    public class CyberTabControl : TabControl
    {
        ...
        private Style CreateCyberTabItemStyle()
        {
            ...
            selectedTrigger.Setters.Add(new Setter(TabItem.FontWeightProperty, FontWeights.Medium)); // �襤�ɵy�L�[���@�I�A�����ϥ� Bold
