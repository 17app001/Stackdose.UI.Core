...
using Stackdose.App.Monitor.Pages;
using Stackdose.App.Monitor.Services;
using Stackdose.App.Monitor.ViewModels;

namespace Stackdose.App.Monitor;
...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _viewModel = new MainWindowViewModel(
            runtimeService: new SinglePageRuntimeService("Stackdose.App.Monitor"),
            closeAction: Close,
