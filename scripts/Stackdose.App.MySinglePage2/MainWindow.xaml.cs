...
using Stackdose.App.MySinglePage2.Pages;
using Stackdose.App.MySinglePage2.Services;
using Stackdose.App.MySinglePage2.ViewModels;

namespace Stackdose.App.MySinglePage2;
...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _viewModel = new MainWindowViewModel(
            runtimeService: new SinglePageRuntimeService("Stackdose.App.MySinglePage2"),
            closeAction: Close,
