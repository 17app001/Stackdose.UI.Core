...
public sealed class ProjectGenerator
{
    ...
    // שששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששש
    //  .csproj
    // שששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששש
    ...
    private void GenerateMainWindowXamlCs()
    {
        ...
        // Usings ¡X deduplicate Pages using
    ...
    private void GenerateCommandHandlers()
    {
        ...
        sb.AppendLine("/// ©R¥O³B²z¾¹ ¡X ¦^¶ַ true = ®״¬[¼g PLC¡A¦^¶ַ false = ¸ץ¹L¡C");
        sb.AppendLine("/// </summary>");
        ...
        foreach (var machine in _spec.Machines)
        {
            ...
            sb.AppendLine();
            sb.AppendLine($"    // ¢w¢w {machine.MachineName} ({machine.MachineId}) ¢w¢w");
            foreach (var cmd in cmds)
            {
                ...
                sb.AppendLine("    {");
                sb.AppendLine($"        // TODO: ¶ס₪J {cmd.CommandName} ֵÞ¿ט");
...
");
    ...
    private void GenerateMaintenanceHandlers()
    {
        ...
        sb.AppendLine();
        L(sb, "/// <summary>÷ûֵ@¼ׂ¦¡³B²z¾¹ ¡X ¦^¶ַ true = ₪¹³\¾Þ§@¡C</summary>");
        ...
        foreach (var machine in _spec.Machines)
        {
            ...
            if (items.Count == 0) continue;
            sb.AppendLine();
            L(sb, $"    // ¢w¢w {machine.MachineName} ({machine.MachineId}) ¢w¢w");
            foreach (var item in items)
            {
                ...
                L(sb, "    {");
                L(sb, $"        // TODO: ¶ס₪J {item.Label} ×÷¦w¥‏ְֻ¬dֵÞ¿ט");
                L(sb, "        return true;");
                L(sb, "    }");
            }
        }
