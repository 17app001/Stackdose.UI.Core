...
- **SecuredButton 擴充** — writeValue / pulse / toggle 三種 commandType，PropertyPanel 完整 UI，修復 commandAddress 讀取 bug
...
| **SecuredButton** | ✅ 已補強 | 支援 writeValue / pulse（寫值→延遲→寫0）/ toggle（讀取→翻轉）三種 commandType |
