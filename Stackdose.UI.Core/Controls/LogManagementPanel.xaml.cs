...

                {
...

                    {
                        ...
                        case LogViewMode.Operation:
                            ...
                            _logService.ExportOperationLogsToPdf(CurrentOperationLogs.ToList(), saveDialog.FileName);
                        ...
                        case LogViewMode.Event:
                            ...
                            _logService.ExportEventLogsToPdf(CurrentEventLogs.ToList(), saveDialog.FileName);
                        ...
                        case LogViewMode.PeriodicData:
                            ...
                            _logService.ExportPeriodicDataLogsToPdf(CurrentPeriodicDataLogs.ToList(), saveDialog.FileName);
