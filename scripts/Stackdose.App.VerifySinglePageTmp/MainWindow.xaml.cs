...
using Stackdose.App.VerifySinglePageTmp.Pages;
using Stackdose.App.VerifySinglePageTmp.Services;
using Stackdose.App.VerifySinglePageTmp.ViewModels;

namespace Stackdose.App.VerifySinglePageTmp;
...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _viewModel = new MainWindowViewModel(
            runtimeService: new SinglePageRuntimeService("Stackdose.App.VerifySinglePageTmp"),
            closeAction: Close,
